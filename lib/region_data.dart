final Map<String, Map<String, List<String>>> regionMap = {
  ...
  '강원특별자치도': {
    '춘천시': ['강남동', '강북', '남면', '남산면', '동내면', '동면', '북산면', '사북면', '서면', '신동면', '신북읍', '조운동', '중앙동', '근화동', '소양동', '교동', '효자동', '후평1동', '후평2동', '후평3동', '석사동', '퇴계동'],
    ...
    '태백시': ['문곡소도동', '상장동', '성황동', '건지동', '황지동', '황연동', '구문소동', '장성동', '철암동'],
  ...
  '충청남도': {
    '천안시': ['목천읍', '풍세면', '광덕면', '성거읍', '직산읍', '입장면', '성환읍', '병천면', '동면', '가락동', '신방동', '일봉동', '봉명동', '중앙동', '문성동', '원성1동', '원성2동', '유량동', '신안동', '성정1동', '성정2동', '쌍용1동', '쌍용2동', '쌍용3동', '불당동', '백석동', '차암동'],
    '공주시': ['웅진동', '금학동', '옥룡동', '중학동', '반죽동', '계룡면', '반포면', '이인면', '탄천면', '우성면', '사곡면', '정안면', '신관동', '월송동', '금흥동', '옥룡동', '웅진동', '산성동', '유구읍'],
  ...
  '전라남도': {
    '목포시': ['연동', '대성동', '죽교동', '원산동', '용해동', '상동', '삼학동', '만호동', '유달동', '목원동', '동명동', '무안동', '온금동', '서산동', '북교동', '보광동', '산정동', '광동동', '달동'],
  ...
  '경상남도': {
    ...
    '진주시': ['문산읍', '내동면', '정촌면', '금곡면', '진성면', '일반성면', '이반성면', '사봉면', '지수면', '대곡면', '명석면', '대평면', '수곡면', '집현면', '미천면', '초장동', '평거동', '신안동', '이현동', '판문동', '가호동', '충무공동'],
    ...
    '양산시': ['삼성동', '강서동', '양주동', '웅상읍', '동면', '상북면', '하북면', '중앙동', '서창동', '소주동', '평산동', '덕계동'],
  },
  '제주특별자치도': {
